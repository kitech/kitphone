...
LIBS += -L../skykit/qmake/cppwrapper -L$$SKYPEKIT_PATH/interfaces/skype/cpp_embedded/build -lskypekit-cppwrapper_2_lib 
win32 {
    LIBS += -lws2_32
} else {
...
########## libjson
INCLUDEPATH += ../libjson
QMAKE_CXXFLAGS += -DJSON_SAFE -DJSON_DEBUG # -ffast-math -fexpensive-optimizations
LIBJSON_SOURCES = ../libjson/Source/internalJSONNode.cpp \

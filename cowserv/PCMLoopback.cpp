	    ...
	    if(input_started)
            {
                ...
                // loop debug, 320 640 320 640
                fprintf(stdout, "loop debug, %d %d %d %d\n", samples, output_buf.size(),
                        input_samples_returned, input_buf[(input_p + 1) % INPUT_BUF_ARRAY_SIZE].size());

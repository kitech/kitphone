...
bool QtLocalPeer::sendMessage(const QString &message, int client_id, int timeout)
{
    if (this->isClient()) {
        return this->clientSendMessage(message, timeout);
    } else {
        return this->serverSendMessage(message, client_id, timeout);
    }
    return true;
}
...
void QtLocalPeer::clientDisconnected()
{
    qDebug()<<__FILE__<<__LINE__<<__FUNCTION__;
    QLocalSocket *socket = (QLocalSocket*)(sender());
    Q_ASSERT(this->clients.contains(socket));

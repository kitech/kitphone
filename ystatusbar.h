...
class YStatusBarPrivate;

// class Q_GUI_EXPORT YStatusBar: public QWidge
// class Q_GUI_EXPORT YStatusBar: public QStatusBar
...
#ifdef QT3_SUPPORT
public:
    QT3_SUPPORT_CONSTRUCTOR YStatusBar(QWidget* parent, const char* name);
...
private:
    Q_DISABLE_COPY(YStatusBar)
    Q_DECLARE_PRIVATE(YStatusBar)
};
